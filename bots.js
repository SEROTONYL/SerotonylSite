(() => {
    ...
    const CASES = {
        ...
        <p><b>Что в итоге:</b> управление доступом и валютой в пару кликов. Меньше ошибок и ручной рутины.</p>
        <p><b>Технические детали:</b> хранение данных и резервные копии, запуск на сервере.</p>
      `
        },
        moderation: {
        ...
        <p><b>Что в итоге:</b> чище сервер и понятная модерация. Меньше ручной работы.</p>
        <p><b>Технические детали:</b> логи и хранение, запуск на сервере.</p>
      `
        },
        payments: {
        ...
        <p><b>Что в итоге:</b> монетизация без ручной выдачи в личку и без постоянных проблем с доступом.</p>
        <p><b>Технические детали:</b> оплата в Telegram, запуск на сервере.</p>
      `
        }
    };

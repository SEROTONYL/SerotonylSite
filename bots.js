(() => {
    ...
    const CASES = {
        wallet: {
            title: "FILE 01 — Экономика/валюта + роли (Telegram)",
            body: `
        <p><b>Задача:</b> валюта, роли, админ-управление без ручной рутины.</p>
        <p><b>Сделано:</b> выдача/списание, мультивыбор пользователей, роли, кнопки админа, хранение данных, логи.</p>
        <p><b>Стек:</b> aiogram, хранение/бэкап, деплой на VPS.</p>
      `
        },
        moderation: {
            title: "FILE 02 — Модерация + антиспам + заявки (Discord)",
            body: `
        <p><b>Задача:</b> снизить флуд/спам и упростить доступ по ролям.</p>
        <p><b>Сделано:</b> фильтры, верификация, заявки, журнал действий, уведомления модерам.</p>
        <p><b>Стек:</b> discord.js, логи/хранение, деплой.</p>
      `
        },
        payments: {
            title: "FILE 03 — Подписка/платежи + доступ (Telegram)",
            body: `
        <p><b>Задача:</b> доступ к контенту по оплате, продления, админ-управление.</p>
        <p><b>Сделано:</b> платёжный сценарий, выдача доступа, продления, защита от ошибок/отмен.</p>
        <p><b>Стек:</b> TG Bot API, payments, деплой.</p>
      `
        }
    };
